  ...
  function continueStory(firstTime) {
    ...
    while (story.canContinue) {
      ...
      if (storyContainer.lastChild.innerHTML.includes("The End.")) {
        ...
        escapeLink.innerHTML = "Navigate to certificate";
        escapeLink.href = "/certificate";
        escapeLink.className = "EscapeStoryLink";
        storyContainer.appendChild(escapeLink);
        const date = new Date();
        localStorage.setItem("completedStory", JSON.stringify(date));
      }
    }
